        ...
        function o() {
          ...
          function p(t, r, e, n) {
            var o = r && r.prototype instanceof x ? r : x,
              ...
              a = new F(n || []);
            return u(i, "_invoke", { value: S(t, e, a) }), i;
          }
          function d(t, r, e) {
            try {
          ...
          function T(t, e) {
            ...
            if ("throw" === i.type)
              return (
                (e.method = "throw"), (e.arg = i.arg), (e.delegate = null), w
              );
            var a = i.arg;
            return a
              ? a.done
          ...
          return (
            (b.prototype = L),
            u(j, "constructor", { value: L, configurable: !0 }),
    ...
    (() => {
      ...
      window.addEventListener("beforeinstallprompt", function (t) {
        ...
        window.addEventListener("appinstalled", function (t) {
          (window.deferredPrompt = null), console.log("JATE was installed.", t);
        });
    })();
})();
