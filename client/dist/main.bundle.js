        ...
        function o() {
          ...
          function p(n, t, e, r) {
            var o = t && t.prototype instanceof w ? t : w,
              ...
              i = new D(r || []);
            return c(a, "_invoke", { value: I(n, e, i) }), a;
          }
          function h(n, t, e) {
            try {
          ...
          var S = Object.getPrototypeOf,
            E = S && S(S(B([])));
          E && E !== a && i.call(E, u) && (k = E);
          var j = (_.prototype = w.prototype = Object.create(k));
          function L(n) {
            ...
            return function (a, i) {
              ...
              for (r.method = a, r.arg = i; ; ) {
                ...
                if ("next" === r.method) r.sent = r._sent = r.arg;
                  ...
                  if (o === v) throw ((o = m), r.arg);
                  r.dispatchException(r.arg);
                } else "return" === r.method && r.abrupt("return", r.arg);
                o = g;
                var u = h(n, e, r);
                if ("normal" === u.type) {
                  if (((o = r.done ? m : y), u.arg === b)) continue;
          ...
          function T(n, e) {
            ...
            var a = h(o, n.iterator, e.arg);
            if ("throw" === a.type)
              return (
                (e.method = "throw"), (e.arg = a.arg), (e.delegate = null), b
              );
            var i = a.arg;
            return i
              ? i.done
          ...
          return (
            (x.prototype = _),
            c(j, "constructor", { value: _, configurable: !0 }),
            c(_, "constructor", { value: x, configurable: !0 }),
            ...
            (e.mark = function (n) {
              return (
                Object.setPrototypeOf
                  ...
                  : ((n.__proto__ = _), d(n, f, "GeneratorFunction")),
            ...
            (D.prototype = {
              ...
              finish: function (n) {
                for (var t = this.tryEntries.length - 1; t >= 0; --t) {
                  ...
                  if (e.finallyLoc === n)
                    return this.complete(e.completion, e.afterLoc), M(e), b;
                }
              },
              catch: function (n) {
                for (var t = this.tryEntries.length - 1; t >= 0; --t) {
        ...
        return "function" == typeof n
          ? (t = n) !== IDBDatabase.prototype.transaction ||
            ...
            ? (
              ...
              ? function (...n) {
                  return t.apply(O(this), n), T(k.get(this));
                }
              : function (...n) {
                  return T(t.apply(O(this), n));
                }
            : function (n, ...e) {
                const r = t.call(O(this), n, ...e);
                return E.set(r, n.sort ? n.sort() : [n]), T(r);
              }
        ...
        return (
          r &&
            i.addEventListener("upgradeneeded", (n) => {
              r(T(i.result), n.oldVersion, n.newVersion, T(i.transaction));
            }),
          ...
          (this.editor = CodeMirror(document.querySelector("#main"), {
            ...
            this.editor.on("blur", function () {
              console.log("The editor has lost focus"),
                U(localStorage.getItem("content"));
            });
        }),
        G = e(379),
        z = e.n(G),
